  ...
  return (
    <section className="mx-auto max-w-5xl px-6 py-12 md:py-16 lg:py-20">
      <div className="text-left">
        ...
        <div className="space-y-4 md:space-y-5 text-base sm:text-lg md:text-xl text-text-neutral leading-relaxed max-w-4xl">
          <p>
      ...
      <div className="mt-10 md:mt-12 space-y-3 md:space-y-4">
        <p className="text-base sm:text-lg md:text-xl flex items-center gap-2 md:gap-3">
        ...
        {[
          ...
          <p key={item} className="text-base sm:text-lg md:text-xl flex items-center gap-2 md:gap-3 text-text-neutral">
            <span className="text-2xl md:text-3xl">👍</span>
            <span>{item}</span>
          </p>
        ))}

        <p className="mt-6 md:mt-8 text-lg sm:text-xl md:text-2xl">
